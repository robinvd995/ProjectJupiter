...
#ifndef JPT_CUSTOM_XML_SOURCE_BUFFER
#define JPT_XML_SOURCE_BUFFER_SIZE 65536
#endif // JPT_CUSTOM_XML_SOURCE_BUFFER
...
namespace Jupiter::Xml {
	...
	inline XmlDocument createDocument(const char* root) {
		...
		data->source_buffer.reserve(JPT_XML_SOURCE_BUFFER_SIZE);
